...
try:
    print("[GAME] Please wait as we import pygame...")
    print("Loading... Process Complete!")
    import pygame
    print("[GAME] Thank you for your patience,")
    print("[GAME] We hope you enjoy ADHARV'S SUPER MINIGOLF!")
except:
...
winwidth = 1080
winheight = 600
pygame.display.set_caption("ADHARV'S SUPER MINIGOLF")
